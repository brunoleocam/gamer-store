...
export interface PropdutoItemProps {
    produto: Produto;
}

export default function ProdutoItem(props: PropdutoItemProps) {
    const { produto } = props;
    return <Link href={`/produto/${produto.id}`}
            className="flex flex-col bg-violet-dark border border-white/10 rouded-xl relative max-w-[350px]"
            >
